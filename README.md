...
## friends-of-hyva/magento2-react-checkout-klarna

Klarna payment method for Hyvä React Checkout

## Prerequisites

1. **[React Checkout](https://github.com/friends-of-hyva/magento2-react-checkout)** is installed and setup.
...
"config": {
    "paymentMethodsRepo": {
      "klarna": "git@github.com:friends-of-hyva/magento2-react-checkout-klarna.git"
    }
},
```
...
- If you need information on the build process of the React Checkout, then you can **[read more about it here](https://friends-of-hyva.github.io/magento2-react-checkout/build/)**.
- If you want to know more about how Hyvä Checkout helps you to integrate any payment methods, then **[read more about it here](https://friends-of-hyva.github.io/magento2-react-checkout/payment-integration/)**.
- The official documentation of **[Hyvä React Checkout](https://friends-of-hyva.github.io/magento2-react-checkout)**
